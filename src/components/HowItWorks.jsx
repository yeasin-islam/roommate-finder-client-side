                ...
                <div className="container mx-auto  text-center">
                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-10 text-left">
                        ...
                        <div className="card bg-base-300 shadow p-5 rounded-xl">
                            ...
                            <p className="">View available listings posted by others. Use filters to narrow by rent, location, and availability.</p>
                        </div>
                        <div className="card bg-base-300 shadow p-5 rounded-xl">
                            <h3 className="text-xl font-semibold mb-2">Step 5: Save Favorites</h3>
                            <p className="">Bookmark listings you like to compare and revisit them later.</p>
                        </div>
                        <div className="card bg-base-300 shadow p-5 rounded-xl">
                        ...
                        <div className="card bg-base-300 shadow p-5 rounded-xl">
                            ...
                            <p className="">Have a conversation, ask questions, and schedule a visit if needed. Trust your vibe check!</p>
                        </div>
                        <div className="card bg-base-300 shadow p-5 rounded-xl">
                            <h3 className="text-xl font-semibold mb-2">Step 9: Finalize & Move In</h3>
                            <p className="">Once it clicks, make arrangements and start your new chapter. 🎉</p>
                        </div>
                    </div>
                </div>
            </div>
